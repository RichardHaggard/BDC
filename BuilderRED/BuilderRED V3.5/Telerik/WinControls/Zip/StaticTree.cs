...
// Type: Telerik.WinControls.Zip.StaticTree
...
namespace Telerik.WinControls.Zip
{
  internal sealed class StaticTree
  {
    ...
    static StaticTree()
    {
      ...
      StaticTree.BitLengths = new StaticTree((short[]) null, Tree.ExtraBits);
      StaticTree.BitLengths.SetParameters(0, 19, 7);
    }

    private StaticTree(short[] treeCodes, int[] extraBits)
    {
    ...
    internal static StaticTree Literals { get; private set; }

    internal static StaticTree Distances { get; private set; }

    internal static StaticTree BitLengths { get; private set; }

    internal short[] TreeCodes { get; private set; }

    internal int[] ExtraBits { get; private set; }

    internal int ExtraBase { get; private set; }

    internal int Elements { get; private set; }

    internal int MaxLength { get; private set; }

    private void SetParameters(int extraBase, int elems, int maxLength)
    {
