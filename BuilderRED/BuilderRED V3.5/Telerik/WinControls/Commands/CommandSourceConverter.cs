...
// Type: Telerik.WinControls.Commands.CommandSourceConverter
...
namespace Telerik.WinControls.Commands
{
  public class CommandSourceConverter : CommandBaseConverter
  {
    ...
    {
      List<IComponent> componentList = CommandBaseConverter.DiscoverCommandsSources(collection);
      ...
      object value)
    {
      ...
      {
        List<IComponent> componentList = CommandBaseConverter.DiscoverCommandsSources(this.GetComponentsReferences(context));
