...
// Type: Telerik.WinControls.UI.FilterPopupRequiredEventArgs
...
namespace Telerik.WinControls.UI
{
  public class FilterPopupRequiredEventArgs : EventArgs
  {
    ...
    public FilterPopupRequiredEventArgs(GridViewDataColumn dataColumn, IGridFilterPopup filterPopup)
    {
