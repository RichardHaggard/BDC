...
// Type: Telerik.WinControls.UI.TabStripPinButtonItemStateManager
...
{
  public class TabStripPinButtonItemStateManager : ButtonItemStateManagerFactory
  {
    protected override StateNodeBase CreateSpecificStates()
    {
      ...
      StateNodeBase state4 = (StateNodeBase) new StateNodeWithCondition("Preview", (Condition) new SimpleCondition(TabStripPinButtonItem.IsPreviewProperty, (object) true));
      StateNodeBase state5 = (StateNodeBase) new StateNodeWithCondition("Pinned", (Condition) new SimpleCondition(TabStripPinButtonItem.IsPinnedProperty, (object) true));
      StateNodeBase state6 = (StateNodeBase) new StateNodeWithCondition("Selected", (Condition) new SimpleCondition(TabStripButtonItem.IsSelectedProperty, (object) true));
      StateNodeBase state7 = (StateNodeBase) new StateNodeWithCondition("Pressed", (Condition) new SimpleCondition(RadButtonItem.IsPressedProperty, (object) true));
