...
// Type: Telerik.WinControls.UI.CommandBarStripElementCollection
...
namespace Telerik.WinControls.UI
{
  ...
  [Serializable]
  public class CommandBarStripElementCollection : CollectionBase, IEnumerable<CommandBarStripElement>, IEnumerable
  {
    private Type[] itemTypes = new Type[1]{ typeof (CommandBarStripElementCollection) };
    ...
    {
      this.OnItemsChanged((CommandBarStripElement) null, ItemsChangeOperation.Clearing);
      if (this.owner == null || !this.owner.IsInValidState(false))
        return;
      this.RemoveAllFromOwner();
    }
    ...
    protected override void OnInsertComplete(int index, object value)
    {
      ...
      this.OnItemsChanged(value as CommandBarStripElement, ItemsChangeOperation.Inserted);
    }
    ...
    protected override void OnRemoveComplete(int index, object value)
    {
      ...
      this.OnItemsChanged(value as CommandBarStripElement, ItemsChangeOperation.Removed);
    }
    ...
    {
      return (IEnumerator<CommandBarStripElement>) new CommandBarStripElementCollection.CommandBarStripElementEnumerator(this);
    }

    public CommandBarStripElementCollection.CommandBarStripElementEnumerator GetEnumerator()
    {
      return new CommandBarStripElementCollection.CommandBarStripElementEnumerator(this);
    }

    protected override void OnRemove(int index, object value)
    {
      this.OnItemsChanged(value as CommandBarStripElement, ItemsChangeOperation.Removing);
    }
    ...
    {
      this.OnItemsChanged((CommandBarStripElement) null, ItemsChangeOperation.Cleared);
    }

    protected virtual void OnSort()
    {
      this.OnItemsChanged((CommandBarStripElement) null, ItemsChangeOperation.Sorting);
    }
    ...
    {
      CommandBarStripElement[] array = new CommandBarStripElement[this.Count];
      this.CopyTo(array, 0);
      return array;
    }
    ...
    public CommandBarStripElement this[int index]
    {
      get
      {
        return (CommandBarStripElement) this.List[index];
      }
      set
      {
    ...
    public CommandBarStripElement this[string itemName]
    {
      get
      {
        for (int index = 0; index < this.List.Count; ++index)
        {
          CommandBarStripElement commandBarStripElement = (CommandBarStripElement) this.List[index];
          if (commandBarStripElement.Name == itemName)
            return commandBarStripElement;
        }
    ...
    public class CommandBarStripElementEnumerator : IEnumerator<CommandBarStripElement>, IDisposable, IEnumerator
    {
      ...
      public CommandBarStripElement Current
      {
        get
        {
          return (CommandBarStripElement) this.baseEnumerator.Current;
        }
      }
