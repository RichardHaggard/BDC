...
// Type: Telerik.WinControls.UI.ImageEditor.Dialogs.SharpenDialog
...
{
  public class SharpenDialog : ImageEditorBaseDialog
  {
    ...
    {
      this.ImageEditorElement.Sharpen((double) (int) this.radSpinEditorValue.Value);
      this.result = DialogResult.OK;
    }

    protected override void LocalizeStrings()
    {
      this.Text = LocalizationProvider<ImageEditorLocalizationProvider>.CurrentProvider.GetLocalizedString("SharpenDialogTitle");
      this.radLabelAmount.Text = LocalizationProvider<ImageEditorLocalizationProvider>.CurrentProvider.GetLocalizedString("SharpenDialogAmount");
      this.radButtonReset.Text = LocalizationProvider<ImageEditorLocalizationProvider>.CurrentProvider.GetLocalizedString("SharpenDialogReset");
    }
