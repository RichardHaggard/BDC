...
// Type: Telerik.WinControls.UI.ToggleSwitchElementStateManager
...
{
  public class ToggleSwitchElementStateManager : ItemStateManagerFactory
  {
    ...
    {
      return (ItemStateManager) new ToggleSwitchButtonStateManager(this.RootState);
    }
  }
}
