...
// Type: Telerik.WinControls.UI.ListViewRowAccessibleObject
...
{
  public class ListViewRowAccessibleObject : AccessibleObject
  {
    private ListViewDataItem item;

    public ListViewRowAccessibleObject(ListViewDataItem item)
    {
      this.item = item;
    }
    ...
    {
      return this.item.Owner.Columns.Count;
    }

    public override AccessibleObject GetChild(int index)
    {
      return (AccessibleObject) new ListViewCellAccessibleObject(this.item, this.item.Owner.Columns[index], (AccessibleObject) this);
    }
