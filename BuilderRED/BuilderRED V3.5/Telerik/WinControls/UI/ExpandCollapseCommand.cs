...
// Type: Telerik.WinControls.UI.ExpandCollapseCommand
...
namespace Telerik.WinControls.UI
{
  public class ExpandCollapseCommand : CommandBase
  {
    ...
    public override object Execute(params object[] settings)
    {
      ...
      if (typeof (RadRibbonBar).IsAssignableFrom(setting.GetType()))
      {
        (setting as RadRibbonBar).Expanded = this.expanded;
