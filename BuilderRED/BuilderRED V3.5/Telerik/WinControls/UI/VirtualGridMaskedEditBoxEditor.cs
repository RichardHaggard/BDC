...
// Type: Telerik.WinControls.UI.VirtualGridMaskedEditBoxEditor
...
namespace Telerik.WinControls.UI
{
  ...
  public class VirtualGridMaskedEditBoxEditor : BaseVirtualGridEditor
  {
    ...
    public override object Value
    {
      ...
      set
      {
        ...
        if (value == null)
        {
          ...
          else if (this.MaskTextBox.MaskType != MaskType.Numeric)
