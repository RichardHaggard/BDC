...
// Type: Telerik.WinControls.UI.VirtualGridTextBoxControlEditor
...
namespace Telerik.WinControls.UI
{
  ...
  public class VirtualGridTextBoxControlEditor : BaseVirtualGridEditor
  {
    ...
    public override void OnKeyDown(KeyEventArgs e)
    {
      ...
      switch (e.KeyCode)
      {
        case Keys.Return:
          ...
          break;
        case Keys.Left:
          if (!this.changed && selectionLength == 0 && (!this.RightToLeft && selectionStart == 0 || this.RightToLeft && selectionStart == textLength))
          {
            base.OnKeyDown(e);
            break;
          }
        ...
        case Keys.Up:
          ...
          break;
        case Keys.Right:
          if (!this.changed && selectionLength == 0 && (!this.RightToLeft && selectionStart == textLength || this.RightToLeft && selectionStart == 0))
          {
            base.OnKeyDown(e);
            break;
          }
