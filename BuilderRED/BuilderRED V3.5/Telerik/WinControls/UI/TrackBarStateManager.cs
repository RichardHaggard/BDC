...
// Type: Telerik.WinControls.UI.TrackBarStateManager
...
{
  public class TrackBarStateManager : ItemStateManagerFactory
  {
    protected override StateNodeBase CreateSpecificStates()
    {
      CompositeStateNode compositeStateNode = new CompositeStateNode("all states");
      StateNodeWithCondition nodeWithCondition = new StateNodeWithCondition("IsVertical", (Condition) new SimpleCondition(TrackBarElementWithOrientation.IsVerticalProperty, (object) true));
