...
// Type: Telerik.WinControls.UI.ApplicationMenuButtonStateManagerFactory
...
namespace Telerik.WinControls.UI
{
  public class ApplicationMenuButtonStateManagerFactory : ItemStateManagerFactory
  {
    public override StateNodeBase CreateRootState()
    {
      ...
      CompositeStateNode compositeStateNode = new CompositeStateNode("BaseStates");
      StateNodeWithCondition nodeWithCondition2 = new StateNodeWithCondition("IsBackstage", (Condition) new SimpleCondition(RadRibbonBarElement.IsBackstageModeProperty, (object) true));
      compositeStateNode.AddState((StateNodeBase) nodeWithCondition2);
      StateNodeWithCondition nodeWithCondition3 = new StateNodeWithCondition("DropDownOpened", (Condition) new SimpleCondition(RadDropDownButtonElement.IsDropDownShownProperty, (object) true));
      compositeStateNode.AddState((StateNodeBase) nodeWithCondition3);
      nodeWithCondition1.TrueStateLink = (StateNodeBase) compositeStateNode;
      nodeWithCondition3.FalseStateLink = this.CreateSpecificStates();
