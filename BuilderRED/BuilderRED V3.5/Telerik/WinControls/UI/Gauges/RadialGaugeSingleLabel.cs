...
// Type: Telerik.WinControls.UI.Gauges.RadialGaugeSingleLabel
...
{
  [Description("Present additional information for the RadRadialGauge, e.g. current value")]
  [Designer("Telerik.WinControls.UI.Design.SingleLabelDesigner, Telerik.WinControls.UI.Design, Version=2018.3.1016.20, Culture=neutral, PublicKeyToken=5bb2a467cbec794e")]
  public class RadialGaugeSingleLabel : GaugeVisualElement, IDrawing
  {
    private float labelFontSize = 8f;
    private string labelFormat = "#,##0.#";
    private SizeF locationPercentage = new SizeF(0.5f, 0.5f);
    ...
    [DefaultValue(typeof (SizeF), "0.5, 0.5f")]
      ...
      get
      {
        ...
        using (Font font = new Font(this.Font.FontFamily, emSize, this.Font.Style))
        {
          using (StringFormat stringFormat = new StringFormat())
          {
            ...
            PointF pt = new PointF(this.owner.GaugeCenter.X + (float) ((double) this.LocationPercentage.Width * (double) this.owner.GaugeSize.Width / 2.0), this.owner.GaugeCenter.Y + (float) ((double) this.locationPercentage.Height * (double) this.owner.GaugeSize.Height / 2.0));
    ...
    public void Paint(Graphics graphics, Rectangle boundingRectangle)
    {
      ...
      using (Font font = new Font(this.Font.FontFamily, emSize, this.Font.Style))
      {
        using (StringFormat format = new StringFormat())
        {
          ...
          if (this.BindValue)
            labelText = this.owner.Value.ToString(this.labelFormat);
          PointF point = new PointF(this.owner.GaugeCenter.X + (float) ((double) this.LocationPercentage.Width * (double) this.owner.GaugeSize.Width / 2.0), this.owner.GaugeCenter.Y + (float) ((double) this.locationPercentage.Height * (double) this.owner.GaugeSize.Height / 2.0));
