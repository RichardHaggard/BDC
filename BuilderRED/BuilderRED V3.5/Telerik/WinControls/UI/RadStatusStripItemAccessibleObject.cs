...
// Type: Telerik.WinControls.UI.RadStatusStripItemAccessibleObject
...
{
  [ComVisible(true)]
  public class RadStatusStripItemAccessibleObject : RadControlAccessibleObject
  {
    private RadItem owner;
    private RadStatusStripAccessibleObject parent;

    public RadStatusStripItemAccessibleObject(
      RadItem owner,
      RadStatusStripAccessibleObject parent,
      string name)
