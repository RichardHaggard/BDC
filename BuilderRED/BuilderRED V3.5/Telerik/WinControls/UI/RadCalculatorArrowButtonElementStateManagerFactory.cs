...
// Type: Telerik.WinControls.UI.RadCalculatorArrowButtonElementStateManagerFactory
...
{
  public class RadCalculatorArrowButtonElementStateManagerFactory : ButtonItemStateManagerFactory
  {
    private RadProperty dropDownProperty;

    public RadCalculatorArrowButtonElementStateManagerFactory(RadProperty dropDownProperty)
    {
