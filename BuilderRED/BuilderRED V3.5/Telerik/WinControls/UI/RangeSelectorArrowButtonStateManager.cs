...
// Type: Telerik.WinControls.UI.RangeSelectorArrowButtonStateManager
...
{
  public class RangeSelectorArrowButtonStateManager : ButtonItemStateManagerFactory
  {
    protected override StateNodeBase CreateSpecificStates()
    {
      CompositeStateNode specificStates = (CompositeStateNode) base.CreateSpecificStates();
      StateNodeWithCondition nodeWithCondition = new StateNodeWithCondition("IsVertical", (Condition) new SimpleCondition(RangeSelectorArrowButton.IsVerticalProperty, (object) true));
