...
// Type: Telerik.WinControls.Data.DoesNotContainFunction
...
{
  internal class DoesNotContainFunction : FilterFunction
  {
    private List<Type> defaultForTypes;
    private List<Type> applicableForTypes;

    public DoesNotContainFunction()
    {
      this.parameterCount = 1;
      this.functionFormat = "[{0}] NOT LIKE '%{1}%'";
      this.mustQuoteValues = false;
      this.gkfunction = GridKnownFunction.DoesNotContain;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionDoesNotContain");
      }
    }
  }
}
