...
// Type: Telerik.WinControls.Data.EndsWithFunction
...
{
  internal class EndsWithFunction : FilterFunction
  {
    ...
    public EndsWithFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.EndsWith;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionEndsWith");
      }
    }
  }
}
