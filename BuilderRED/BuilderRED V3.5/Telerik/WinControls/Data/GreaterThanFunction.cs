...
// Type: Telerik.WinControls.Data.GreaterThanFunction
...
{
  internal class GreaterThanFunction : FilterFunction
  {
    ...
    public GreaterThanFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.GreaterThan;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionGreaterThan");
      }
    }
  }
}
