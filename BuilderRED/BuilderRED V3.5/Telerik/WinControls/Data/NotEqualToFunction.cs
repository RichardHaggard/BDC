...
// Type: Telerik.WinControls.Data.NotEqualToFunction
...
{
  internal class NotEqualToFunction : FilterFunction
  {
    ...
    public NotEqualToFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.NotEqualTo;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionNotEqualTo");
      }
    }
  }
}
