...
// Type: Telerik.WinControls.Data.NotIsEmptyFunction
...
{
  internal class NotIsEmptyFunction : FilterFunction
  {
    private List<Type> defaultForTypes;
    private List<Type> applicableForTypes;

    public NotIsEmptyFunction()
    {
      this.parameterCount = 0;
      this.functionFormat = "[{0}] <> ''";
      this.mustQuoteValues = false;
      this.gkfunction = GridKnownFunction.NotIsEmpty;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionNotIsEmpty");
      }
    }
  }
}
