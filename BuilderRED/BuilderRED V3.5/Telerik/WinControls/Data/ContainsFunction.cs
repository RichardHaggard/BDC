...
// Type: Telerik.WinControls.Data.ContainsFunction
...
{
  internal class ContainsFunction : FilterFunction
  {
    ...
    public ContainsFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.Contains;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionContains");
      }
    }
  }
}
