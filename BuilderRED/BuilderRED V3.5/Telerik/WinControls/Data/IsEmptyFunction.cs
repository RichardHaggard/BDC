...
// Type: Telerik.WinControls.Data.IsEmptyFunction
...
{
  internal class IsEmptyFunction : FilterFunction
  {
    ...
    public IsEmptyFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.IsEmpty;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionIsEmpty");
      }
    }
  }
}
