...
// Type: Telerik.WinControls.Data.NotIsNullFunction
...
{
  internal class NotIsNullFunction : FilterFunction
  {
    private List<Type> defaultForTypes;
    private List<Type> applicableForTypes;

    public NotIsNullFunction()
    {
      this.parameterCount = 0;
      this.functionFormat = "NOT ([{0}] IS NULL)";
      this.mustQuoteValues = false;
      this.gkfunction = GridKnownFunction.NotIsNull;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionNotIsNull");
      }
    }
  }
}
