...
// Type: Telerik.WinControls.Data.LessThanOrEqualToFunction
...
{
  internal class LessThanOrEqualToFunction : FilterFunction
  {
    ...
    public LessThanOrEqualToFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.LessThanOrEqualTo;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionLessThanOrEqualTo");
      }
    }
  }
}
