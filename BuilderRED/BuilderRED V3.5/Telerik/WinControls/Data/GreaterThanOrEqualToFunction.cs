...
// Type: Telerik.WinControls.Data.GreaterThanOrEqualToFunction
...
{
  internal class GreaterThanOrEqualToFunction : FilterFunction
  {
    ...
    public GreaterThanOrEqualToFunction()
    {
      ...
      this.gkfunction = GridKnownFunction.GreaterThanOrEqualTo;
    }
    ...
    public override string DisplayName
    {
      get
      {
        return LocalizationProvider<RadGridLocalizationProvider>.CurrentProvider.GetLocalizedString("FilterFunctionGreaterThanOrEqualTo");
      }
    }
  }
}
